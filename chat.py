...
def check_db_exists():
    ...
    if not db_path.exists():
        ...
        console.print("  Ejecuta primero: [bold]python ingest.py[/bold]")
        sys.exit(1)
...
def build_chat_engine(verbose: bool):
    ...
    # Motor de chat con memoria conversacional
...
def print_sources(source_nodes):
    ...
    table.add_column("Página", justify="center", style="dim")
...
def chat_loop(verbose: bool):
    ...
    try:
        ...
        console.print("  Verifica que Ollama está corriendo y que el modelo está disponible:")
